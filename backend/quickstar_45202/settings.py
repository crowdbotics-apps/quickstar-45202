"""
Django settings for quickstar_45202 project.
...
ROOT_URLCONF = 'quickstar_45202.urls'
...
WSGI_APPLICATION = 'quickstar_45202.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quickstar_45202 API",
    "DESCRIPTION": "API documentation for quickstar_45202 App",
    "VERSION": "v1",
}
